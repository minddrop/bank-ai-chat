...
- **Penetration Testing & Red Teaming**: Multi-tier automated security test matrix evaluating SSE buffer starvation, indirect RAG vector injection, and In-VPC KMS token vault isolation ([ADR 0021](docs/adr/0021-comprehensive-dlp-penetration-testing-and-security-evaluation.md)).

...
- **NFR-02 (Latency)**: Lump-sum <800ms SLA without microservice latency decomposition across inline DLP, RAG retrieva## 3. Section 2: Refined & Augmented Requirements List (RFC 2119 Standards)

### 3.1 Inbound Guardrails & PII Sanitization (Pre-LLM)

*(See [ADR-0001](file:///home/joe/src/bank-ai-chat/docs/adr/0001-japanese-banking-compliance-and-control-planes.md), [ADR-0009](file:///home/joe/src/bank-ai-chat/docs/adr/0009-dlp-security-guardrails-and-compliance-framework.md), and [ADR-0012](file:///home/joe/src/bank-ai-chat/docs/adr/0012-in-vpc-salted-tokenization-vault.md))*
...
- **REQ-IN-01 [PII Redaction & Cryptographic Salted Tokenization]**:
  ...
  - Raw PII **MUST NOT** be passed to Bedrock LLM endpoints under any circumstances. Matched PII **SHALL** be replaced with cryptographically salted UUID tokens (`[TOKEN_ACCT_a1b2c3d4]`) stored in an In-VPC KMS-encrypted temporary token vault using a dynamic HMAC salt fetched from Secrets Manager (`bank-ai/vault-hmac-salt`). *(See [ADR-0012](file:///home/joe/src/bank-ai-chat/docs/adr/0012-in-vpc-salted-tokenization-vault.md))*

- **REQ-IN-02 [Direct & Indirect Prompt Injection Defense]**:
  - The Inbound Guardrail **SHALL** scan all input payloads and retrieved RAG context chunks against an active threat classifier to detect direct prompt injection, jailbreak attempts, system prompt extraction, and indirect prompt injection attacks embedded in untrusted external text. *(See [ADR-0009](file:///home/joe/src/bank-ai-chat/docs/adr/0009-dlp-security-guardrails-and-compliance-framework.md))*
...
*(See [ADR-0009](file:///home/joe/src/bank-ai-chat/docs/adr/0009-dlp-security-guardrails-and-compliance-framework.md) and [ADR-0013](file:///home/joe/src/bank-ai-chat/docs/adr/0013-sse-streaming-and-guardrail-buffer-architecture.md))*
...
- **REQ-OUT-02 [RAG Grounding & Hallucination Entailment Verification]**:
  ...
  - The generated response **MUST** achieve an NLI Entailment Score >= 0.85 (85%). Responses falling below 0.85 **MUST** be suppressed and replaced with verified RAG reference excerpts. *(See [ADR-0009](file:///home/joe/src/bank-ai-chat/docs/adr/0009-dlp-security-guardrails-and-compliance-framework.md))*
...
- **REQ-OUT-04 [FIEA Investment Prohibitions vs. Permitted Personalized Banking Reasoning]**:
  - The Outbound Guardrail **SHALL** evaluate responses for compliance with the Financial Instruments and Exchange Act (FIEA Article 38). *(See [ADR-0009](file:///home/joe/src/bank-ai-chat/docs/adr/0009-dlp-security-guardrails-and-compliance-framework.md) and [ADR-0010](file:///home/joe/src/bank-ai-chat/docs/adr/0010-personalized-account-tier-reasoning.md))*
...
*(See [ADR-0014](file:///home/joe/src/bank-ai-chat/docs/adr/0014-zero-trust-step-up-authentication-boundary.md), [ADR-0015](file:///home/joe/src/bank-ai-chat/docs/adr/0015-opensearch-serverless-network-isolation-and-vector-dimension-standard.md), and [ADR-0017](file:///home/joe/src/bank-ai-chat/docs/adr/0017-enterprise-iam-least-privilege-access-and-kms-key-policy-topology.md))*
...
- **REQ-SEC-03 [Step-Up Auth & Action Boundary Isolation]**:
  ...
  - Transactional requests (fund transfers 振込, PIN changes, account closures) **MUST** trigger a mandatory Step-Up Authentication prompt directing the user to authenticated Internet Banking via OIDC/FIDO2. *(See [ADR-0014](file:///home/joe/src/bank-ai-chat/docs/adr/0014-zero-trust-step-up-authentication-boundary.md))*

- **REQ-SEC-04 [Least-Privilege Core Banking Integration]**:
  - Core banking data retrieval APIs **MUST** authenticate using short-lived OAuth 2.0 mTLS tokens with strictly scoped read-only access (`scope: read:account_balance read:transactions`). *(See [ADR-0005](file:///home/joe/src/bank-ai-chat/docs/adr/0005-hybrid-cloud-and-aws-poc-architecture.md) and [ADR-0008](file:///home/joe/src/bank-ai-chat/docs/adr/0008-decoupled-core-banking-database-and-api.md))*
...
*(See [ADR-0001](file:///home/joe/src/bank-ai-chat/docs/adr/0001-japanese-banking-compliance-and-control-planes.md), [ADR-0009](file:///home/joe/src/bank-ai-chat/docs/adr/0009-dlp-security-guardrails-and-compliance-framework.md), and [ADR-0018](file:///home/joe/src/bank-ai-chat/docs/adr/0018-production-observability-cloudwatch-alarms-and-security-telemetry-targets.md))*
...
- **REQ-AUD-01 [Cryptographic SHA-256 Tamper-Evident Logging]**:
  ...
  - Each log entry **MUST** contain: `session_id`, UTC timestamp, `customer_id` hash, sanitized prompt, raw guardrail status flags, Bedrock token usage, response latency, and a cryptographic `SHA-256` signature computed over the concatenated log payload. *(See [ADR-0009](file:///home/joe/src/bank-ai-chat/docs/adr/0009-dlp-security-guardrails-and-compliance-framework.md))*

- **REQ-AUD-02 [10-Year WORM Immutable Storage]**:
  - Audit logs **MUST** be streamed to Amazon CloudWatch Logs and archived to Amazon S3 buckets configured with S3 Object Lock in Compliance Mode (Write Once Read Many - WORM) with a 10-year retention lock per FISC and Japanese Banking Act mandates. *(See [ADR-0009](file:///home/joe/src/bank-ai-chat/docs/adr/0009-dlp-security-guardrails-and-compliance-framework.md))*

- **REQ-AUD-03 [Real-Time Guardrail Telemetry & CloudWatch Security Hub]**:
  - High-severity security events (prompt injection attempts, outbound PII reflection, grounding score failures < 0.70) **MUST** publish metrics to CloudWatch and trigger automated AWS Security Hub alerts within < 5 seconds. *(See [ADR-0018](file:///home/joe/src/bank-ai-chat/docs/adr/0018-production-observability-cloudwatch-alarms-and-security-telemetry-targets.md))*
...
| Requirement ID | Requirement Summary | PCI-DSS 4.0 | CFPB AI Guidance | GLBA Safeguards | SR 11-7 / OCC | ISO 42001 / AIUC-1 | NYDFS Part 500 | FISC Security | APPI / FSA / FIEA (Japan) | Governing ADR |
|---|---|---|---|---|---|---|---|---|---|---|
| **REQ-IN-01** | Multi-Pattern PII Redaction & Salted Tokenization | Req 3.3, 3.4 (Card Masking) | - | § 314.4(c)(1) (NPI Encryption) | - | A.8.2 (Data Protection) | 500.15 (NPI Protection) | Sec 3.1 (Data Sovereignty) | APPI Art 20/23 (Anonymization) | [ADR-0001](file:///home/joe/src/bank-ai-chat/docs/adr/0001-japanese-banking-compliance-and-control-planes.md), [ADR-0012](file:///home/joe/src/bank-ai-chat/docs/adr/0012-in-vpc-salted-tokenization-vault.md) |
| **REQ-IN-02** | Direct & Indirect Prompt Injection Defense | Req 6.4.3 (Web App Attack Mitig.) | Inaccurate Info Rules | § 314.4(c)(2) (Access Control) | Risk Mitig. | A.6.2 (AI Attack Vectors) | 500.02 (Cyber Program) | Sec 4.1 (System Integrity) | FSA AI Safety Guidelines | [ADR-0001](file:///home/joe/src/bank-ai-chat/docs/adr/0001-japanese-banking-compliance-and-control-planes.md), [ADR-0009](file:///home/joe/src/bank-ai-chat/docs/adr/0009-dlp-security-guardrails-and-compliance-framework.md) |
| **REQ-IN-03** | Unicode, Cipher & Smuggling Normalization | Req 6.4.3 | - | - | - | A.8.4 (Input Sanitization) | 500.02 | Sec 4.1 | FSA Tech Guidelines | [ADR-0009](file:///home/joe/src/bank-ai-chat/docs/adr/0009-dlp-security-guardrails-and-compliance-framework.md) |
| **REQ-IN-04** | Input Payload Truncation & Token Budgeting | Req 6.4.3 | - | - | - | A.9.1 (Robustness) | 500.02 | Sec 4.1 | FISC Infrastructure Standard | [ADR-0009](file:///home/joe/src/bank-ai-chat/docs/adr/0009-dlp-security-guardrails-and-compliance-framework.md) |
| **REQ-IN-05** | Executable Code & SSRF Prevention | Req 6.4.3 (Injection Defenses) | - | § 314.4(c)(2) | - | A.8.4 | 500.02 | Sec 4.1 | FISC Web Security Standard | [ADR-0009](file:///home/joe/src/bank-ai-chat/docs/adr/0009-dlp-security-guardrails-and-compliance-framework.md) |
| **REQ-OUT-01** | Outbound PII Reflection & Leakage Scan | Req 3.3, 3.4 | Deceptive Practice Rules | § 314.4(c)(1) | - | A.8.2 | 500.15 | Sec 3.1 | APPI Art 20 (Zero PII Outbound) | [ADR-0009](file:///home/joe/src/bank-ai-chat/docs/adr/0009-dlp-security-guardrails-and-compliance-framework.md) |
| **REQ-OUT-02** | RAG Grounding NLI Entailment (>= 0.85) | - | Accurate Info Circular | - | Conceptual Soundness | A.8.3 (Output Validation) | 500.02 | Sec 4.2 | FSA AI Explainability Standard | [ADR-0009](file:///home/joe/src/bank-ai-chat/docs/adr/0009-dlp-security-guardrails-and-compliance-framework.md) |
| **REQ-OUT-03** | Financial Numeric & Value Verification | - | Anti-Deception Circular | - | Model Outcomes | A.8.3 | 500.02 | Sec 4.2 | FSA Consumer Protection | [ADR-0009](file:///home/joe/src/bank-ai-chat/docs/adr/0009-dlp-security-guardrails-and-compliance-framework.md) |
| **REQ-OUT-04** | FIEA Investment Advice Prohibition | - | Unfair Practices | - | Model Risk Scope | A.9.2 (Behavior Boundaries) | 500.02 | Sec 4.2 | FIEA Article 38 (Solicitation) | [ADR-0009](file:///home/joe/src/bank-ai-chat/docs/adr/0009-dlp-security-guardrails-and-compliance-framework.md), [ADR-0010](file:///home/joe/src/bank-ai-chat/docs/adr/0010-personalized-account-tier-reasoning.md) |
| **REQ-OUT-05** | Mandatory Legal Disclaimer Appending | - | Clear Disclosure Rules | - | Disclosure Mandate | A.9.3 (User Disclosure) | 500.02 | Sec 4.2 | Banking Act / FSA Guidance | [ADR-0009](file:///home/joe/src/bank-ai-chat/docs/adr/0009-dlp-security-guardrails-and-compliance-framework.md) |
| **REQ-SEC-01** | Zero-Trust Session Memory Isolation | Req 8.4 (Access Boundary) | - | § 314.4(c)(2) | - | A.7.1 (System Boundary) | 500.12 (Access Mgt) | Sec 3.2 (Session Protection)| APPI Data Isolation Mandate | [ADR-0001](file:///home/joe/src/bank-ai-chat/docs/adr/0001-japanese-banking-compliance-and-control-planes.md) |
| **REQ-SEC-02** | RAG Vector Index RBAC & Tier Filtering | Req 7.1, 7.2 (Role-Based Access) | - | § 314.4(c)(2) | Data Controls | A.7.2 (Access Controls) | 500.07 (Access Privileges)| Sec 3.2 | FISC Access Control Rules | [ADR-0003](file:///home/joe/src/bank-ai-chat/docs/adr/0003-rakuten-bank-faq-rag-pipeline.md), [ADR-0015](file:///home/joe/src/bank-ai-chat/docs/adr/0015-opensearch-serverless-network-isolation-and-vector-dimension-standard.md) |
| **REQ-SEC-03** | Step-Up Auth & Action Boundary Isolation | Req 8.4 (MFA Rules) | Human Escalation / Auth | § 314.4(c)(2) | Governance | A.7.3 (Action Control) | 500.12 (MFA Rule) | Sec 3.2 | Banking Act (Ginkō Hō) | [ADR-0014](file:///home/joe/src/bank-ai-chat/docs/adr/0014-zero-trust-step-up-authentication-boundary.md) |
| **REQ-SEC-04** | Core Banking API Least-Privilege mTLS | Req 4.1, 6.4 | - | § 314.4(c)(1) | - | A.7.2 | 500.14 (Monitoring) | Sec 5.1 (TLS 1.3) | FISC API Security Rules | [ADR-0005](file:///home/joe/src/bank-ai-chat/docs/adr/0005-hybrid-cloud-and-aws-poc-architecture.md), [ADR-0008](file:///home/joe/src/bank-ai-chat/docs/adr/0008-decoupled-core-banking-database-and-api.md) |
| **REQ-SEC-05** | System Prompt Vault Integrity Monitoring | Req 10.5 (Integrity Controls) | - | § 314.4(e) | Governance | A.6.1 (System Integrity) | 500.06 (Audit Trails) | Sec 4.2 | FISC Configuration Control | [ADR-0009](file:///home/joe/src/bank-ai-chat/docs/adr/0009-dlp-security-guardrails-and-compliance-framework.md) |
| **REQ-AUD-01** | SHA-256 Tamper-Evident Audit Logging | Req 10.2, 10.3 (Audit Logs) | Compliance Logging | § 314.4(e) (Audit System) | Monitoring | A.10.1 (Logging & Audit) | 500.06 (Audit Trail) | Sec 4.2 (Cryptographic Logs)| Banking Act Audit Mandate | [ADR-0001](file:///home/joe/src/bank-ai-chat/docs/adr/0001-japanese-banking-compliance-and-control-planes.md), [ADR-0009](file:///home/joe/src/bank-ai-chat/docs/adr/0009-dlp-security-guardrails-and-compliance-framework.md) |
| **REQ-AUD-02** | 10-Year WORM Immutable Storage | Req 10.7 (Retention) | - | § 314.4(e) | Inventory | A.10.2 (Log Protection) | 500.06 | Sec 4.2 (10-Yr Storage) | Banking Act 10-Year Lock | [ADR-0009](file:///home/joe/src/bank-ai-chat/docs/adr/0009-dlp-security-guardrails-and-compliance-framework.md) |
| **REQ-AUD-03** | Telemetry & Security Hub Alerting | Req 10.4, 10.6 (Log Review) | Monitoring | § 314.4(h) | Oversight | A.10.3 (Incident Mgt) | 500.17 (Notif.) | Sec 4.2 | FISC Incident Response | [ADR-0018](file:///home/joe/src/bank-ai-chat/docs/adr/0018-production-observability-cloudwatch-alarms-and-security-telemetry-targets.md) |
| **REQ-AUD-04** | SR 11-7 Model Risk Monitoring | - | Auditing AI | - | Model Validation | A.6.3 (Ongoing Validation)| 500.02 | Sec 4.2 | FSA AI Governance Guidelines | [ADR-0018](file:///home/joe/src/bank-ai-chat/docs/adr/0018-production-observability-cloudwatch-alarms-and-security-telemetry-targets.md) |
| **REQ-AUD-05** | CFPB AI Transparency & Human Escalation | - | Non-Deception Circular | - | Governance | A.9.3 (AI Identification) | - | - | FSA Customer Protection | [ADR-0001](file:///home/joe/src/bank-ai-chat/docs/adr/0001-japanese-banking-compliance-and-control-planes.md) |

---

## 5. Section 4: Recommended Non-Functional Requirements (NFRs)

### 5.1 Microservice Latency Budget Breakdown *(See [ADR-0007](file:///home/joe/src/bank-ai-chat/docs/adr/0007-production-aws-detailed-design-specification.md), [ADR-0011](file:///home/joe/src/bank-ai-chat/docs/adr/0011-compute-architecture-re-evaluation-ecs-vs-lambda.md))*
...
### 5.2 Availability, Throughput & Disaster Recovery Targets *(See [ADR-0011](file:///home/joe/src/bank-ai-chat/docs/adr/0011-compute-architecture-re-evaluation-ecs-vs-lambda.md))*
...
### 5.3 Deterministic Failure-Mode Behaviors & Circuit Breakers *(See [ADR-0009](file:///home/joe/src/bank-ai-chat/docs/adr/0009-dlp-security-guardrails-and-compliance-framework.md))*
